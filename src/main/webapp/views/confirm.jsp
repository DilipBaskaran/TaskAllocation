...
<body>
	...
	<div class="container">
		...
		<form action="/user/confirmuser" method="post">
			...
			<div class="form-group">
				<label for="uniqueno"><spring:message code="lbl.shoppingcart.login.uniqueno" /></label> <input type="text"
					class="form-control" id="uniqueno" name="uniqueno">
			</div>
